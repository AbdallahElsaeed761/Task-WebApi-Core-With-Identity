        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShoppingBasketBookID = table.Column<int>(type: "int", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ShoppingBasketBooks", x => x.ID);
                    table.ForeignKey(
                        name: "FK_ShoppingBasketBooks_Customers_CustomerID",
                        column: x => x.CustomerID,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Books_ShoppingBasketBooks_ShoppingBasketBookID",
                        column: x => x.ShoppingBasketBookID,
                        principalTable: "ShoppingBasketBooks",
                        principalColumn: "ID",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Books_ShoppingBasketBookID",
                table: "Books",
                column: "ShoppingBasketBookID");

            migrationBuilder.CreateIndex(
                name: "IX_Customers_ShoppingBasketBookID",
                table: "Customers",
                column: "ShoppingBasketBookID");

            migrationBuilder.CreateIndex(
                name: "IX_ShoppingBasketBooks_CustomerID",
                table: "ShoppingBasketBooks",
                column: "CustomerID");

            migrationBuilder.AddForeignKey(
                name: "FK_Customers_ShoppingBasketBooks_ShoppingBasketBookID",
                table: "Customers",
                column: "ShoppingBasketBookID",
                principalTable: "ShoppingBasketBooks",
                principalColumn: "ID",
